...
print("{}".format("raghu"))     # 'raghu'
print("{{}}".format("raghu"))   # '{}' (it think braces to be printed)
print("{{{}}}".format("raghu")) # '{raghu}'
print()

print("{} and {}".format("cat", "dog"))
print("{} and {}".format(213, "dog"))
...
print("Name:{} Age:{} Salary:{}".format("raghu", 30, 9999.9999))
print(
    """
        Name  :{}
        Age   :{}
...
print(
    """
        ...
        NAME="raghu", AGE=99, SALARY=9999.9999
    )
)
...
result = {
    "customer": "Raghavendra rav",
    "accound_last_4_digits": 1134,
    "transaction_amount": "87.5 crores",
    "transaction_time": "12th June 1947 12:34:45",
}
